from bdbag import BAG_PROFILE_TAG as BAG_PROFILE_TAG, BDBAG_PROFILE_ID as BDBAG_PROFILE_ID, DEFAULT_CONFIG_PATH as DEFAULT_CONFIG_PATH, VERSION as VERSION, get_typed_exception as get_typed_exception, parse_version as parse_version, safe_move as safe_move
from bdbag.fetch import Megabyte as Megabyte
from bdbag.fetch.auth.keychain import DEFAULT_KEYCHAIN_FILE as DEFAULT_KEYCHAIN_FILE, write_keychain as write_keychain
...
def read_config(config_file: Any | None = ..., create_default: bool = ..., auto_upgrade: bool = ...): ...
def upgrade_config(config_file) -> None: ...
def copy_config_items(old_config, new_config, key_names): ...
def bootstrap_config(config_file=..., keychain_file=..., base_dir: Any | None = ...) -> None: ...
