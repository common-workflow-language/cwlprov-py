...
class Path:
    ...
    def eval(self, graph, subj: Any | None = ..., obj: Any | None = ...) -> Generator[Any, None, None]: ...
    def __hash__(self): ...
...
class SequencePath(Path):
    ...
    def eval(self, graph, subj: Any | None = ..., obj: Any | None = ...) -> Generator[None, None, Any]: ...
    def n3(self): ...
...
class MulPath(Path):
    ...
    def eval(self, graph, subj: Any | None = ..., obj: Any | None = ..., first: bool = ...) -> Generator[Any, None, None]: ...
    def n3(self): ...
